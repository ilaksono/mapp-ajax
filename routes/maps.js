    ...
    dbHelpers.loadAllMaps()
      .then(maps => {
        for (const map of maps) {
          ...
          .then(markerArray => {
            const mapStaticURL = dbHelpers.buildStaticURL(map.center_latitude, map.center_longitude, zoomIndex, 220, 250, "AIzaSyAzhpPYg-ucwzqHgAPqZfYbXVnmsMazg2I", markerArray);
